...
$('#ldhcqclick').click(function(){
  $('#ldhcqdiv').css({"display":"block"});
  $('#jzwhcqdiv').css({"display":"none"});
});
$('#jzwhcqclick').click(function(){
    $('#jzwhcqdiv').css({"display":"block"});
    $('#ldhcqdiv').css({"display":"none"});
  });
...
$('#hcqcx').click(function(){
    $('#hcq').css({"display":"block"});
    $('#ld').css({"display":"none"});
    $('#nh').css({"display":"none"});
    $('#xc').css({"display":"none"});
    $('#lh').css({"display":"none"});
