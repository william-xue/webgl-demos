...
var gongyuanSource = new ol.source.Vector(
    {
        url: '../parse/1649470124085.json',
        projection: 'EPSG:4326',
        format: new ol.format.GeoJSON(),
    });

var gongyuanVector = new ol.layer.Vector(
    {
        title: "公园",
        source: gongyuanSource,
        style: function (f) {
            return new ol.style.Style({
                text: new ol.style.Text({
                    text: f.get('name').toString(),
...
var mousePositionControl = new ol.control.MousePosition({
    coordinateFormat: ol.coordinate.createStringXY(2), projection: 'EPSG:4326',
...
var map = new ol.Map({
    ...
    view: new ol.View({
        projection: "EPSG:4326",
        zoom: 11,
        center: [113.313644, 23.009278]
    }),
    // layers: [baseLayers, gongyuanVector, brgm, labels]
    layers: [baseLayers],
